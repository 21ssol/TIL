...
public class ReplyController {
  private static final Logger log = LoggerFactory.getLogger(ReplyController.class); // 로그기록
  ...
  public ResponseEntity<String> getPage(int nPage, int nowPage, int bbsno, String col, String word) {
    ...
    // rpaging : url, nPage, bbsno를 가지고 들어간다.
