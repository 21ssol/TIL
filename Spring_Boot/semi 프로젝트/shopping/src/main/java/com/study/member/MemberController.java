...
public class MemberController {
 ...
 @ResponseBody
 public MemberDTO pwFind(@RequestParam String id, @RequestParam String email) {
   
   Map map = new HashMap();
   map.put("id", id);
   map.put("email", email);
   
   MemberDTO dto = service.pwFind(map);
 ...
 @ResponseBody
 public MemberDTO idFind(@RequestParam String mname, @RequestParam String email) {
   
   Map map = new HashMap();
   map.put("mname", mname);
   map.put("email", email);
   
   MemberDTO dto = service.idFind(map);
