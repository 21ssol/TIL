...
<input type="hidden" name = 'addressnum' value="<%=dto.getAddressnum() %>">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="address" id="sample6_address" class="form-control" value="<%=dto.getAddress() %>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
    <textarea rows="5" cols="5" id="sample6_detailAddress" name="address2" class="form-control"><%=dto.getAddress2() %></textarea>
    </div>
  </div>
   <div class="form-group">
   <div class="col-sm-offset-2 col-sm-5">
    ...
    <button class="btn"  type="button" onclick="location.href='/addr/list'">목록</button>
   </div>
 </div>
