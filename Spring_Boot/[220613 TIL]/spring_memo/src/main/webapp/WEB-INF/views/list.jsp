...
<%@ page import="java.util.*, com.study.model.MemoDTO, com.study.utility.*" %>
<% 
//getAttribute는 setattribute가 필요하다
...
<body> 
<div class="container">
<h1 class="col-sm-offset-2 col-sm-10">메모목록</h1>
...
<% if(list.size()==0) { %>
<tr>
<td colspan='7'>등록된 글이 없습니다.</td></tr>
